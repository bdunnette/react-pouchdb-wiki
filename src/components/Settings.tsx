...
export const Settings: React.FC = () => {
  const [remoteUrl, setRemoteUrl] = useState(
    localStorage.getItem("couchdb_url") || "",
  );
  const [syncStatus, setSyncStatus] = useState<
    "idle" | "syncing" | "error" | "connected"
  >("idle");
  ...
  return (
    <div style={{ maxWidth: "600px", margin: "0 auto", padding: "60px 40px" }}>
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                padding: "12px",
                background:
                  theme === option.id ? "var(--accent-color)" : "transparent",
      ...
      >
        ...
        >
          Sync your wiki across multiple devices by connecting to a CouchDB
          instance.
        </p>
        ...
        <button
          ...
          style={{
            ...
            padding: "12px",
            background:
              syncStatus === "error" ? "#ef4444" : "var(--accent-color)",
            color: "white",
            fontWeight: 600,
          }}
        >
        ...
        {syncStatus !== "idle" && (
          ...
          >
            ...
            <span>
              {syncStatus === "error"
                ? "Failed to connect. Check URL/CORS."
